    ...
    public partial class NthSubnetPage : ContentPage
    {
        ...
        async void GetResults_Clicked(object sender, EventArgs e)
        {
            ...
            await Task.Run(() =>
            {
                ...
                {
                    DisplayAlert("Errore", "La subnet mask inserita non è valida", "OK");
                    return;
                }
                else if (valueEntry.Text == null || !IsValueValid())
                {
                    DisplayAlert("Errore", "Il numero inserito non è valido", "OK");
                    return;
                }
